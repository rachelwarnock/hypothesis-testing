...
.large[Within your group, try to get as much done as possible in the time allocated for the course.]
...
.large[It's up to each group how to divide the tasks.]
...
.pull-right[
# Why does paleobiology include so much statistics?
...
* Can you think of a scenario where statistics might be useful or important?
* Discuss the examples on the next slides.
...
* What types of data are used in your paper? Make a note.
...
Don't worry about getting it perfect, you can go back and refine the wording later.
