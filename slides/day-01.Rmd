...
---
  class: middle
background-image: url("cont_discrete.png")
background-size: contain
background-size: 70%
background-position: right
...
---
  class: middle
background-image: url("nom_ord_bin.png")
background-size: contain
...
Not sure the following is necessary - suggest using the Variance lecture from R programming

---
  background-image: url("giraffes2.png")
background-size: contain
background-position: bottom

## Imagine that you've visited two islands of tiny giraffes...


---
  background-image: url("giraffes3.png")
background-size: contain
background-position: bottom

---
background-image: url("normal1.png")
background-size: contain
