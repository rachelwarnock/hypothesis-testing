...
```{r, echo = FALSE}
library(kableExtra)
urls <- c("slides/day-02.html","slides/test-statistics.pdf",NA,NA,NA,NA,NA)
...
* [Learning statistics with R: Chapter 13 11](https://learningstatisticswithr.com/book/ttest.html)
